...
const navigation: NavigationItem[] = [
  ...
  {
    name: "GitHub",
    href: "https://github.com/BOUISMA2X4",
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
    ...
    <footer className="bottom-0 mt-auto w-screen pb-8 pt-8">
      <div
        className="
                  ...
                  flex-col justify-between gap-4 font-normal text-neutral-700
                  sm:flex-row sm:gap-0 md:items-center
                "
      >
        <p className="flex text-xs leading-5 text-neutral-500 md:justify-center">
          &copy; {`${year}`} Built by{" "}
          <Link
            href="https://github.com/BOUISMA2X4"
